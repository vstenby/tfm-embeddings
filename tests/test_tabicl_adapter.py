"""TabICL backend tests. Skipped when tabicl is not installed."""
...
def test_similarity_and_search(fitted_model, data):
    _, _, X_query = data
...
def test_identical_row_is_most_similar(fitted_model, data):
    X_corpus, _, _ = data
